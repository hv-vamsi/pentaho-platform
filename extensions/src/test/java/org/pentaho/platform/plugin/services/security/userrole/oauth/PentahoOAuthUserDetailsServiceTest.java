...
public class PentahoOAuthUserDetailsServiceTest {
  ...
  public void testLoadUserByUsername() {
    PentahoOAuthUserDetailsService pentahoOAuthUserDetailsService = spy(new PentahoOAuthUserDetailsService(userRoleListService));

    Authentication authentication = mock(Authentication.class);

    when(authentication.getName()).thenReturn("JOE");
    when(userRoleListService.getRolesForUser(null, authentication.getName())).thenReturn(List.of("Administrator", "Authenticated"));
