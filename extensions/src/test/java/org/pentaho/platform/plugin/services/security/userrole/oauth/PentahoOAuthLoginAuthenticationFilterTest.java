...
public class PentahoOAuthLoginAuthenticationFilterTest {
  ...
  public void testAttemptAuthenticationWithRepository() {
    PentahoOAuthLoginAuthenticationFilter filter = spy(new PentahoOAuthLoginAuthenticationFilter(clientRegistrationRepository, authorizedClientRepository, "/", roleMapper));
  ...
  public void testAttemptAuthentication() {
    PentahoOAuthLoginAuthenticationFilter filter = spy(new PentahoOAuthLoginAuthenticationFilter(clientRegistrationRepository, authorizedClientService, "/", roleMapper));
    HttpServletRequest request = mock(HttpServletRequest.class);
    HttpServletResponse response = mock(HttpServletResponse.class);
    Authentication authentication = mock(Authentication.class);
