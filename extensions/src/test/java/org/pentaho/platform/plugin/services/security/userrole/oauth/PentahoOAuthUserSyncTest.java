...
public class PentahoOAuthUserSyncTest {
  ...
  public void testReadAllUsers() {
    PentahoOAuthUserSync pentahoOAuthUserSync = spy( new PentahoOAuthUserSync( userRoleDao, pentahoOAuthProviderFactory ) );
  ...
  public void testPerformSyncForUser() {
    PentahoOAuthUserSync pentahoOAuthUserSync = spy( new PentahoOAuthUserSync( userRoleDao, pentahoOAuthProviderFactory ) );
    PentahoOAuthUser pentahoOAuthUser = new PentahoOAuthUser( new PentahoUser( "admin", "password", "", true ), "azure", "" );
